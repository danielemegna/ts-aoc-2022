...
describe('first part resolution', () => {
    ...
    describe('inspected item counts for monkey', () => {
        ...
        describe('with worry level reduction', () => {

            test('after 1 round', () => {
                const actual = inspectedItemCountsForMonkeyWith(parsedMonkeysProvidedExample, 1, true)
                expect(actual).toStrictEqual([2, 4, 3, 5])
            })

            test('after 20 rounds', () => {
                const actual = inspectedItemCountsForMonkeyWith(parsedMonkeysProvidedExample, 20, true)
    ...
    test('solve with provided example', () => {
        const actual = levelOfMonkeyBusiness(providedInputExample, 20, true)
        expect(actual).toBe(101 * 105)
    })

    test('solve with input from file', () => {
        const input = readFileSync('./test/day11/input.txt', 'utf-8')
        const actual = levelOfMonkeyBusiness(input, 20, true)
...
describe('second part resolution', () => {
    ...
    describe('inspected item counts for monkey', () => {
        ...
        describe('without worry level reduction', () => {

            test('after 1 round', () => {
                const actual = inspectedItemCountsForMonkeyWith(parsedMonkeysProvidedExample, 1, false)
                expect(actual).toStrictEqual([2, 4, 3, 6])
            })

            test('after 20 rounds', () => {
                const actual = inspectedItemCountsForMonkeyWith(parsedMonkeysProvidedExample, 20, false)
                expect(actual).toStrictEqual([99, 97, 8, 103])
            })

            test('after 1000 rounds', () => {
                const actual = inspectedItemCountsForMonkeyWith(parsedMonkeysProvidedExample, 1000, false)
                expect(actual).toStrictEqual([5204, 4792, 199, 5192])
            })

            test('after 5000 rounds', () => {
                const actual = inspectedItemCountsForMonkeyWith(parsedMonkeysProvidedExample, 5000, false)
                expect(actual).toStrictEqual([26075, 23921, 974, 26000])
            })

            test('after 10000 rounds', () => {
                const actual = inspectedItemCountsForMonkeyWith(parsedMonkeysProvidedExample, 10000, false)
    ...
    test('solve with provided example', () => {
        const actual = levelOfMonkeyBusiness(providedInputExample, 10000, false)
        expect(actual).toBe(52166 * 52013)
    })

    test('solve with input from file', () => {
        const input = readFileSync('./test/day11/input.txt', 'utf-8')
        const actual = levelOfMonkeyBusiness(input, 10000, false)
